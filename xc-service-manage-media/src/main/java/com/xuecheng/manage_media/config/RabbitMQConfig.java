...
public class RabbitMQConfig {
    ...
    public Queue QUEUE_PROCESSTASK() {
        Queue queue = new Queue(queue_media_video_processor,true,false,true);
        return queue;
    }
    /**
     * 绑定队列到交换机 .
     ...
     */
    @Bean
    public Binding binding_queue_media_processor(@Qualifier("queue_media_video_processor") Queue queue, @Qualifier(EX_MEDIA_PROCESSTASK) Exchange exchange) {
